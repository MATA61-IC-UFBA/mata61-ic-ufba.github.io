...
| 2 (T) | 11/3 |[Conceitos básicos de análise léxica](https://www3.nd.edu/~dthain/compilerbook/chapter3.pdf). Revisão: Expressões regulares (ER) e Autômatos Finitos | | |
| 3 (P) | 16 | Implementação de analisadores léxicos. Flex | Exercício 1 - Calculadora: aspectos léxicos | |
| 4 (T) | 18 | [Conceitos básicos de análise sintática](https://www3.nd.edu/~dthain/compilerbook/chapter4.pdf) | Apresentação da especificação de T1 | |
